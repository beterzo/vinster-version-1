...
Schrijf deze samenvatting in gewone, toegankelijke taal die iemand zó kan overnemen als profieltekst, bijvoorbeeld op LinkedIn. Vermijd gezwollen, formele of "dure" woorden en vage clichés. Schrijf vanuit wat iemand DOET, leuk vindt of waar anderen hem of haar van kennen, niet vanuit abstracte eigenschappen of categorieën. Gebruik gewone werkwoorden, zoals "ik zet me graag in voor", "ik houd ervan om", "ik blijf mezelf graag ontwikkelen" of "mensen kennen me als". Verboden woorden en constructies: "wordt gekenmerkt door", "een diepe interesse in", "een sterke drang naar", "intrinsiek gemotiveerd", "mijn capaciteiten", "maatschappelijke thema's", "persoonlijke groei", "in mijn sociale omgang" en "hecht veel waarde aan". Het mag niet kinderachtig of simpel klinken, maar wel natuurlijk en helder, zoals je het tegen een collega zou zeggen. Voorbeeld 1, te gezwollen: "Mijn persoonlijke identiteit wordt gekenmerkt door een diepe interesse in mensen en een sterke drang naar educatie en dierenwelzijn." Goed: "Ik ben geïnteresseerd in alles wat met leren en ontwikkelen te maken heeft. Daarnaast zet ik me graag in voor dierenwelzijn." Voorbeeld 2, nog steeds te afstandelijk: "Ik ben intrinsiek gemotiveerd door maatschappelijke thema's zoals dierenwelzijn en kansen op de arbeidsmarkt. Mijn capaciteiten als ontwikkelaar en communicator sluiten hier goed op aan. In mijn sociale omgang ben ik trouw en zorgzaam." Zo moet het wel: "Ik zet mij graag in voor onderwerpen die ertoe doen, zoals dierenwelzijn en gelijke kansen op werk. Ik houd ervan om nieuwe dingen te ontwikkelen en kennis te delen. Mensen kennen mij als loyaal en zorgzaam."`,
...
Write this summary in plain, accessible language that someone could copy straight into a profile text, for example on LinkedIn. Avoid inflated, formal or "fancy" words and vague clichés. Write from what someone DOES, enjoys or is known for by others, not from abstract traits or categories. Use plain verbs, like "I like to commit myself to", "I enjoy", "I keep developing myself" or "people know me as". Forbidden words and constructions: "is characterised by", "a deep interest in", "a strong drive towards", "intrinsically motivated", "my capabilities", "societal themes", "personal growth", "in my social interactions" and "I greatly value". It should not sound childish or oversimplified, but natural and clear, the way you would say it to a colleague. Example 1, too inflated: "My personal identity is characterised by a deep interest in people and a strong drive towards education and animal welfare." Good: "I'm interested in everything to do with learning and development. I also like to commit myself to animal welfare." Example 2, still too distant: "I'm intrinsically motivated by societal themes such as animal welfare and opportunities in the labour market. My capabilities as a developer and communicator align well with this. In my social interactions I'm loyal and caring." This is how it should be: "I like to commit myself to things that matter, such as animal welfare and equal opportunities at work. I enjoy developing new things and sharing knowledge. People know me as loyal and caring."`,
...
Schreibe diese Zusammenfassung in einfacher, verständlicher Sprache, die jemand direkt als Profiltext übernehmen könnte, zum Beispiel auf LinkedIn. Vermeide geschwollene, formelle oder "gehobene" Wörter und vage Klischees. Schreibe aus dem heraus, was jemand TUT, gerne mag oder wofür andere ihn kennen, nicht aus abstrakten Eigenschaften oder Kategorien. Verwende einfache Verben, wie "ich setze mich gerne ein für", "ich mag es", "ich entwickle mich gerne weiter" oder "andere kennen mich als". Verbotene Wörter und Konstruktionen: "ist gekennzeichnet durch", "ein tiefes Interesse an", "ein starkes Streben nach", "intrinsisch motiviert", "meine Fähigkeiten", "gesellschaftliche Themen", "persönliches Wachstum", "in meinem sozialen Umgang" und "lege großen Wert auf". Es soll nicht kindisch oder zu simpel klingen, sondern natürlich und klar, so wie du es einem Kollegen sagen würdest. Beispiel 1, zu geschwollen: "Meine persönliche Identität ist gekennzeichnet durch ein tiefes Interesse an Menschen und ein starkes Streben nach Bildung und Tierwohl." Gut: "Ich interessiere mich für alles, was mit Lernen und Entwicklung zu tun hat. Außerdem setze ich mich gerne für das Tierwohl ein." Beispiel 2, noch zu distanziert: "Ich bin intrinsisch motiviert durch gesellschaftliche Themen wie Tierwohl und Chancen auf dem Arbeitsmarkt. Meine Fähigkeiten als Entwickler und Kommunikator passen gut dazu. In meinem sozialen Umgang bin ich treu und fürsorglich." So soll es sein: "Ich setze mich gerne für Themen ein, die wirklich zählen, wie Tierwohl und gleiche Chancen bei der Arbeit. Ich entwickle gerne neue Dinge und teile mein Wissen. Andere kennen mich als treu und fürsorglich."`,
...
Skriv dette sammendraget i et enkelt og tilgjengelig språk som noen kan kopiere rett inn som profiltekst, for eksempel på LinkedIn. Unngå oppblåste, formelle eller "fine" ord og vage klisjeer. Skriv ut fra hva noen GJØR, liker eller er kjent for av andre, ikke ut fra abstrakte egenskaper eller kategorier. Bruk vanlige verb, som "jeg engasjerer meg gjerne for", "jeg liker å", "jeg fortsetter å utvikle meg" eller "folk kjenner meg som". Forbudte ord og konstruksjoner: "kjennetegnes av", "en dyp interesse for", "en sterk trang til", "indre motivert", "mine evner", "samfunnstemaer", "personlig vekst", "i min sosiale omgang" og "legger stor vekt på". Det skal ikke høres barnslig eller for enkelt ut, men naturlig og tydelig, slik du ville sagt det til en kollega. Eksempel 1, for oppblåst: "Min personlige identitet kjennetegnes av en dyp interesse for mennesker og en sterk trang til utdanning og dyrevelferd." Bra: "Jeg er interessert i alt som har med læring og utvikling å gjøre. I tillegg engasjerer jeg meg gjerne for dyrevelferd." Eksempel 2, fortsatt for distansert: "Jeg er indre motivert av samfunnstemaer som dyrevelferd og muligheter på arbeidsmarkedet. Mine evner som utvikler og kommunikator passer godt til dette. I min sosiale omgang er jeg trofast og omsorgsfull." Slik skal det være: "Jeg engasjerer meg gjerne for ting som betyr noe, som dyrevelferd og like muligheter i arbeidslivet. Jeg liker å utvikle nye ting og dele kunnskap. Folk kjenner meg som trofast og omsorgsfull."`
  };
