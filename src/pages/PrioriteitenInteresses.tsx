...
const INTERESSES_KEYWORDS = [
  "Architectuur", "Automatisering", "Cultuur", "Data", "Design", "Duurzaamheid",
  "Economie", "Educatie", "Entertainment", "Filosofie", "Financiën", "Fotografie",
  "Gastronomie", "Gezondheid", "Handel", "Historie", "ICT", "Innovatie",
  "Journalistiek", "Kunst", "Literatuur", "Marketing", "Milieu", "Mode",
  "Muziek", "Natuur", "Politiek", "Psychologie", "Reizen", "Sport",
  "Taal", "Technologie", "Theater", "Wetenschap", "Zorg"
];
        ...
        <Card className="rounded-3xl shadow-xl">
          <CardContent className="p-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-8">
              {INTERESSES_KEYWORDS.map((keyword) => (
                <button
                  key={keyword}
