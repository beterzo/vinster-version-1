...
const INTERESSES_KEYWORDS = ["Architectuur", "Automatisering", "Cultuur", "Data", "Design", "Duurzaamheid", "Economie", "Educatie", "Entertainment", "Filosofie", "Financiën", "Fotografie", "Gastronomie", "Gezondheid", "Handel", "Historie", "ICT", "Innovatie", "Journalistiek", "Kunst", "Literatuur", "Marketing", "Milieu", "Mode", "Muziek", "Natuur", "Politiek", "Psychologie", "Reizen", "Sport", "Taal", "Technologie", "Theater", "Wetenschap", "Zorg"];
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-[1440px] mx-auto px-6 py-4">
          <div className="flex items-center">
            <img alt="Vinster Logo" className="h-20 w-auto cursor-pointer hover:opacity-80 transition-opacity duration-200" onClick={() => navigate('/home')} src="/lovable-uploads/62ab9b10-8f6f-47ff-b35a-f701338dddfe.png" />
          </div>
        </div>
      </div>
        ...
        <Card className="rounded-3xl shadow-xl">
          <CardContent className="p-12">
            ...
            <div className="mb-8">
              ...
              <Textarea id="extraText" placeholder="Bijvoorbeeld: Blockchain, Dierenrechten, Voeding..." value={extraText} onChange={e => handleExtraTextChange(e.target.value)} onBlur={handleExtraTextBlur} className="min-h-[80px] border-gray-300 focus:border-blue-900 focus:ring-blue-900" />
            </div>
