  ...
  return <div className="min-h-screen bg-gray-50 font-sans">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        backgroundColor: '#E6F0F6'
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-6 bg-white rounded-lg">
              <Star className="w-12 h-12 mx-auto mb-4" style={{
              color: '#78BFE3'
            }} />
            ...
            <div className="text-center p-6 bg-white rounded-lg">
              <Briefcase className="w-12 h-12 mx-auto mb-4" style={{
              color: '#78BFE3'
            }} />
              <h3 className="font-bold text-lg mb-2">Fijne werkomgeving</h3>
              <p className="text-gray-600 text-sm">Omstandigheden waarin jij je het beste voelt</p>
            </div>

            <div className="text-center p-6 bg-white rounded-lg">
              <Target className="w-12 h-12 mx-auto mb-4" style={{
              color: '#78BFE3'
            }} />
        ...
        <div className="flex justify-between items-center">
          ...
          <Button onClick={() => navigate("/prioriteiten-activiteiten")} className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-8 text-xl rounded-3xl shadow-lg hover:shadow-xl transition-all duration-200" size="lg">
