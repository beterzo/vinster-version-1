      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-[1440px] mx-auto px-6 py-4">
          <div className="flex items-center">
            <img alt="Vinster Logo" className="h-20 w-auto cursor-pointer hover:opacity-80 transition-opacity duration-200" onClick={() => navigate('/home')} src="/lovable-uploads/d9afcf52-75df-4ee9-8b87-c0676bfcb583.png" />
          </div>
        </div>
      </div>
        ...
        <Card className="rounded-3xl shadow-xl mb-8">
          <CardContent className="p-12">
            ...
            <div className="text-center">
              <Button onClick={() => navigate('/home')} size="lg" className="bg-blue-900 hover:bg-blue-800 text-white font-semibold px-8 py-4 rounded-lg flex items-center gap-2 mx-auto">
