          ...
          backgroundColor: '#A9C5E2'
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-white">
                ...
                {isPdfReady ? <Button onClick={downloadPdf} className="bg-white text-blue-900 hover:bg-gray-100 font-bold px-8 py-4 rounded-full text-lg shadow-lg hover:shadow-xl transition-all duration-200" size="lg">
