...
const OnderzoeksplanInline = ({ subStep, onNext, onPrevious }: OnderzoeksplanInlineProps) => {
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-[#E8F4FD] rounded-full flex items-center justify-center mx-auto mb-6">
                <CheckCircle className="w-8 h-8 text-[#232D4B]" />
              </div>
  ...
  // page3
  const steps = [
    t('journey.onderzoeksplan.page3.step6'),
    t('journey.onderzoeksplan.page3.step7'),
    t('journey.onderzoeksplan.page3.step8'),
    t('journey.onderzoeksplan.page3.step9'),
    t('journey.onderzoeksplan.page3.step10'),
  ];
  ...
  return (
    <Card className="rounded-3xl shadow-xl border-0">
      <CardContent className="p-8 md:p-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold text-[#232D4B] mb-8">
            {t('journey.onderzoeksplan.page3.title')}
          </h1>
