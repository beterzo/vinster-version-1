...
const ProgressStep = ({ title, description, progress, isCompleted = false, icon, compact = false }: ProgressStepProps) => {
  if (compact) {
    return (
      <Card className="p-4 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
